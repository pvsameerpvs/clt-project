...
export default function ComplimentarySamplesPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header Banner */}
      <div className="bg-[#F5EBEB] py-24 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="max-w-3xl">
            <Sparkles className="h-12 w-12 text-neutral-400 mb-6" />
            ...
            <p className="text-xl md:text-2xl font-light text-neutral-600 leading-relaxed max-w-xl">
              Receive two complimentary luxury miniatures with every online order.
            </p>
          </div>
        </div>
      </div>

...
export default function StocksPage() {
  ...
  const loadProducts = useCallback(async () => {
    try {
      ...
      toast.error(loadError instanceof Error ? loadError.message : "Unable to load stock inventory.")
    } finally {
      setLoading(false)
    }
  }, [])
  ...
  async function handleStockChange(product: AdminProduct, nextStock: number) {
    try {
      ...
      toast.error(updateError instanceof Error ? updateError.message : "Unable to update stock.")
    } finally {
